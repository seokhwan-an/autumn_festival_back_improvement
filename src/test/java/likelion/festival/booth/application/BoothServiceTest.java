...
class BoothServiceTest {
    ...
    void create_booth() {
        ...
        assertAll(
            ...
            () -> assertThat(result.getBoothType()).isEqualTo(BoothType.valueOf(boothCreate.getBoothType())),
    ...
    void update_booth() {
        ...
        assertAll(
            ...
            () -> assertThat(result.getBoothType()).isEqualTo(BoothType.valueOf(boothUpdate.getBoothType())),
